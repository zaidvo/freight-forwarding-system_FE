// src/modules/operations/pages/PackingListPage.tsx
import { useState } from "react";
import { AppLayout } from "@/components/layout/AppLayout";
import { Button } from "@/components/ui/Button";
import { Download, Eye, FileText } from "lucide-react";
import { PackingListFormPanel } from "../components/PackingListForm";
import { PackingListPreview } from "../components/PackingListPreview";
import type { PackingListForm } from "../types";
import { EMPTY_PACKING_LIST } from "../data/seed";

export default function PackingListPage() {
  const [form, setForm] = useState<PackingListForm>(EMPTY_PACKING_LIST);
      ...
      <div className="mx-auto max-w-7xl space-y-5">
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <p className="mt-1 text-[14px] text-slate-500">
              Create and manage cargo packing details for customs and shipping.
            </p>
          </div>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          <div className={mobileTab === "preview" ? "hidden lg:block" : ""}>
            <PackingListFormPanel form={form} onChange={setForm} />
          </div>
